...
par = JudgeSystem();
%% Define File Path
CopyPath  = ['G:' par 'NearWallCases' par 'FishNearPlants' par 'SourceData' par 'Part2_2' par 'NaturalFrequency'];
PastePath = ['G:' par 'NearWallCases' par 'FishNearPlants' par 'PostData'   par 'Part2_2' par 'NaturalFrequency'];
