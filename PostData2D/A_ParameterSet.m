...
par = JudgeSystem();
%% Define File Path
CopyPath  = ['G:' par 'NearWallCases' par 'FishNearPlants' par 'SourceData' par 'Part2_1' par 'Re200Kf3.50D0.50H1.00L1.00F0.60Kp'];
PastePath = ['G:' par 'NearWallCases' par 'FishNearPlants' par 'PostData'   par 'Part2_1' par 'Re200Kf3.50D0.50H1.00L1.00F0.60Kp'];
FileList = ('K5.00');
